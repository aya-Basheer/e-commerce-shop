...
<div class="blog-section">
    <div class="container">
        <div class="row">
            ...
            <!-- باقي المقالات انسخ نفس البلوك وعدل الصورة والنص -->
        </div>
    </div>
</div>
<!-- End Blog Section -->
            ...
            <div class="col-lg-12">
                <div class="testimonial-slider-wrap text-center">
                    ...
                    <div class="testimonial-slider">
                                ...
                                <div class="col-lg-8 mx-auto">
                                    <div class="testimonial-block text-center">
                                        <blockquote class="mb-5">
                                            <p>&ldquo;Donec facilisis quam ut purus rutrum lobortis. Donec vitae odio quis nisl dapibus malesuada.&rdquo;</p>
                                        </blockquote>
                        ...
                        <!-- تقدر تكرر عناصر Testimonials هنا -->
                    </div>
